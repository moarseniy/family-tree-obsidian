...
A plugin that automatically generates an interactive family tree from your Obsidian notes. Simply create notes with parent links in YAML frontmatter, and the plugin visualizes relationships as an inverted tree (you at the base).
